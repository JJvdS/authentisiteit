        ...
        <div className="nav">
            ...
            <div className="nav-wrapper">
                <div className="nav-item">
                    <NavLink className="clickable" to="/overmij">
                        Over mij
                    </NavLink>
                </div>
                <div className="nav-item">
                    <NavLink className="clickable" to="/hoeikhelp">
                        Hoe ik help
                    </NavLink>
                </div>
                <div className="nav-item">
                    <NavLink className="clickable" to="/blog">
                        Blog
                    </NavLink>
                </div>
            ...
            <div className={`menu ${isActive ? 'active' : ''}`}>
                <div className="items-container">
                    <div className="menu-item clickable" onClick={closeMenu}>
                        <NavLink className="clickable" to="/overmij">
                            Over mij
                        </NavLink>
                    </div>
